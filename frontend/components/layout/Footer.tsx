...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#01000b] border-t border-white/5 pt-16 pb-8 overflow-hidden">
      {/* Background overlay */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-radial-glow pointer-events-none rounded-full blur-3xl opacity-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div 
              ...
              onClick={scrollToTop}
            >
              <div className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg">
            ...
            <p className="text-sm text-neutral-400 max-w-sm leading-relaxed mb-6">
              AI-powered platform that automatically finds the best moments in your long videos and transforms them into engaging, viral shorts.
            </p>

            {/* Social Icons */}
            <div className="flex items-center gap-4 text-neutral-500">
              <a href="#" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center border border-white/5 hover:border-violet-500/30 hover:bg-violet-600/10 hover:text-white transition-all">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Features', 'How it Works', 'Showcase', 'Pricing', 'FAQ'].map((link) => (
                <li key={link}>
                  <a
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <p className="text-xs text-neutral-500">
            &copy; {currentYear} ViralCraft. All rights reserved.
          </p>
          <p className="text-xs text-neutral-500">
            Built with 💜 for high-conversions.
          </p>
        </div>
      </div>
    </footer>
