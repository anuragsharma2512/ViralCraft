  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        >
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/25">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-[#030014]/95 backdrop-blur-lg border-b border-white/5 py-6 px-6 flex flex-col gap-6 animate-fade-in">
          ...
          <button
            onClick={() => scrollToSection('cta')}
            className="w-full py-3 px-6 text-center text-sm font-medium text-white rounded-full bg-linear-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 shadow-lg shadow-violet-500/25 transition-all cursor-pointer"
          >
            Join Waitlist
          </button>
        </div>
